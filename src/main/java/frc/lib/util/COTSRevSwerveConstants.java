...
public class COTSRevSwerveConstants {
    ...
    public COTSRevSwerveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, double angleKF, boolean driveMotorInvert, boolean angleMotorInvert, boolean canCoderInvert){
    ...
    public static COTSRevSwerveConstants SDSMK3(double driveGearRatio){
        ...
        return new COTSRevSwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD, angleKF, driveMotorInvert, angleMotorInvert, canCoderInvert);
    }

    /** Swerve Drive Specialties - MK4 Module*/
    public static COTSRevSwerveConstants SDSMK4(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static COTSRevSwerveConstants SDSMK4i(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static COTSRevSwerveConstants WCPxFlippedGear(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static COTSRevSwerveConstants WCPxFlippedBelt(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static COTSRevSwerveConstants WCPxNonFlippedBelt(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static COTSRevSwerveConstants REVMaxSwerve(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
