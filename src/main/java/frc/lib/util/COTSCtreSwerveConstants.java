...
public class COTSCtreSwerveConstants {
    ...
    public COTSCtreSwerveConstants(double wheelDiameter, double angleGearRatio, double driveGearRatio, double angleKP, double angleKI, double angleKD, InvertedValue driveMotorInvert, InvertedValue angleMotorInvert, SensorDirectionValue cancoderInvert){
    ...
    public static COTSCtreSwerveConstants SDSMK3(double driveGearRatio){
        ...
        return new COTSCtreSwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKI, angleKD, driveMotorInvert, angleMotorInvert, cancoderInvert);
    }

    /** Swerve Drive Specialties - MK4 Module*/
    public static COTSCtreSwerveConstants SDSMK4(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
    ...
    public static COTSCtreSwerveConstants SDSMK4i(double driveGearRatio){
        double wheelDiameter = Units.inchesToMeters(4.0);
